...
def set_style_excel(column_index, path_to_excel, columns_to_convert, data):
    ...
    a = styles_dict['Мероприятие']
    styles_dict['Мероприятие'] = styles_dict['Веха']
    styles_dict['Веха'] = a
...
def main(path_to_project):
    ...
    try:
        ...
        path_to_excel = path_to_project.replace('.mpp', '.xlsx')
...
if __name__ == "__main__":
    start = time.time()
    print(main(r"C:\Users\semenhomec\PycharmProjects\pythonProject2\Еженедельные  КСГ (Сила Сибири ,Чаянда, Ковыыкта) 04.05\Чаянда\051-2000860_2023_нг_ф (04.05).mpp"))
    end = time.time()
    print(end - start)
